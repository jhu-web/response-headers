...
public class MessageImage {
  ...
  /**
   * Creates an Image of a string with an oblique shadow behind it. Used by the
   * ShadowedText servlet.
   */
  ...
  /**
   * We need a Graphics object to get a FontMetrics object (an object that says how big
   * strings are in given fonts). But, you need an image from which to derive the Graphics
   * object. Since the size of the "real" image will depend on how big the string is, we
   * create a very small temporary image first, get the FontMetrics, figure out how big
   * the real image should be, then use a real image of that size.
   */
