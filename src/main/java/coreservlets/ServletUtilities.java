...
/**
   * Replaces characters that have special HTML meanings with their corresponding HTML
   * character entities.
   * Given a string, this method replaces all occurrences of '<' with '&lt;', <br> 
   * all occurrences of '>' with '&gt;', and (to handle cases that occur inside <br>
   * attribute values), all occurrences of double quotes with '&quot;' and all <br>
   * occurrences of '&' with '&amp;'. Without such filtering, an arbitrary string could 
   * not safely be inserted in a Web page.
   */
