...
/**
 * Creates an ArrayList of large prime numbers, usually in a low-priority background
...
public class PrimeList
  ...
  /**
   * Finds numPrimes prime numbers, each of which is numDigits long or longer. You can set
   * it to return only when done, or have it return immediately, and you can later poll it
