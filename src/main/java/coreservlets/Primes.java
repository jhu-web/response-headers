...
/**
 * A few utilities to generate a large random BigInteger, and find the next prime number
 * above a given BigInteger.
 * <p>
...
public class Primes {
  ...
  private static StringBuffer[] digits = {new StringBuffer("0"), new StringBuffer("1"),
    new StringBuffer("2"), new StringBuffer("3"), new StringBuffer("4"),
    new StringBuffer("5"), new StringBuffer("6"), new StringBuffer("7"),
  ...
  /**
   * Create a random big integer where every digit is selected randomly (except that the
  ...
  /**
   * Simple command-line program to test. Enter number of digits, and the program picks a
   * random number of that length and then prints the first 50 prime numbers above that.
   */
